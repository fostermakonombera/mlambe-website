...
<body class="border-success">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand" href="#">
              ...
              <a class="navbar-brand" href="#">
                    <h3 class="fw-bold">MLAMBE MISSION HOSPITAL</h3>
                    <h6>P.O BOX 45,LUNZU BLANTYRE MALAWI</h6>
              </a>
              ...
              <div class="collapse navbar-collapse justify-content-end align-center" id="navMain">
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <a class="nav-link active bg-success rounded" aria-current="page" href="#">Home</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="container-fluid vh-100" >
              <div class="row">
                  <div class=" card col-12 col-sm-12 col-md-12 col-lg-12 border-black" style="background-image:url(pics/home.jpg);
                  height:100vh; background-size:cover;"><br>
                     <br> <div class=" bg-transparent">
                     
                     <h1 class="card-title fw-bold text-center text-white">WELCOME<br></h1>
                          <div class="card-body text-center">
                          <h4 class="card-title fw-bold text-center text-white fade-in"><br><br><br><br><br><br><br><br>
                          <br><br><br><b><marquee >We provide quality and holistic health care services.</marquee></b></h4>
                          </div>
...
Copyright &copy;2025 Mlambe ICT Team. All rights Reserved<br></FOOTER>
</body>
</html>
