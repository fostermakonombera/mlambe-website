...
<body>
    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand" href="#">
              ...
              <div class="collapse navbar-collapse justify-content-end align-center" id="navMain">
                <ul class="navbar-nav">
                   <li class="nav-item">
                    <a class="nav-link active bg-success rounded" aria-current="page" href="#">Blog</a>
                  </li>
          ...
          <h2 class="bg-success text-white rounded p-4">HOSPITAL BLOGS<h2>
          </div>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<div class='card bg-image text-white border-success col-sm-12 col-md-6 col-lg-5  m-auto mb-3 py-4'>
            ...
            <h2 class='btn bg-white fw-bold text-success rounded'>" . htmlspecialchars($row['title']) . "</h2>
            
            <p><a class='btn bg-transparent fw-bold text-success' href='viewblog1.php? id= ".$row['id']."'>Read more...</a></p>
            <small class='btn bg-transparent fw-bold text-success rounded'>Posted on: " . $row['created_at'] . "</small>
            </div>
            </div>";
        }
    } else {
