...
<body class="vh-100">
    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
          ...
          <div class=" container-fluid bg-white col-sm-12">
          <div class="text-center col-sm-12">
          <h2 class="bg-success text-white rounded p-4">CLIENTS FEEDBACK<h2>
          </div>
          <div class="container-fluid">
          <div class="row">
         ...
         <div class="col-sm-12 col-md-6 col-lg-10 text-center vh-100">
         <h2 class="bg-white text-success rounded shadow">FEEDBACK</h2>
         ...
         if($result->num_rows>0){
          ...
          echo"<table class='table table-sm col-sm-12 wrap-text table table-striped' border='1'>";
          echo"<tr>
                   <th>Name</th>
                   <th>Email</th>
          ...
          echo"<tr>
                  <td>" . $row['name'] . "</td>
                  <td>" . $row['email'] . "</td>
                  <td>" . $row['type_of_msg'] . "</td>
                  <td>" . $row['message'] . "</td>
                  <td><a class='nav-link bg-danger rounded' href='deletefeed.php?id=".$row['id']."'>Delete</a></td>
              </tr>";
