    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand" href="#">
              ...
              <div class="collapse navbar-collapse justify-content-end align-center" id="navMain">
                <ul class="navbar-nav">
                   <li class="nav-item">
                    <a class="nav-link active bg-success rounded" aria-current="page" href="#">FAQ</a>
                  </li>
         ...
         if($result->num_rows>0){
          while($row=$result->fetch_assoc()){
            echo"<div class='card col-sm-12 col-md-12 col-lg-12 text-center bg-white text-black border-0 m-auto mb-3 py-4'>
            <div class='dropdown card col-sm-12 col-md-12 col-lg-12'>
            <a class=' btn btn-white text-success border-success dropdowm-toggle' href='#' role='button'
             data-bs-toggle='dropdown' 
           aria-expanded='false'>".$row['question']."</a>
            <ul class='dropdown-menu dropdown-menu-sm-start '>
            <li><p class='dropdown-item text-wrap'>Answer : ".$row['answer']."</p></li>
             </ul>
             </div>
             </div>";
          }
