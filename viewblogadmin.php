...
<body>
    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
         ...
         <div id="toggle-button" class="bg-white text-success rounded shadow"><h3>MENU</h3></div><br>
         <div id="content" style="display:none;">
         <div class="bg-success text-white py-5 mb-3 rounded"><a href="admin.php" class="nav-link">Dashboard</a></div>
         <div class="bg-success text-white py-5 mb-3 rounded"><a href="postblog.php" class="nav-link">Add Blog</a></div>
         ...
         <h2 class="bg-white text-success rounded shadow">BLOGS/NEWS LETTER</h2>
        
         <?php
         if($result->num_rows>0){
          while($row=$result->fetch_assoc()){
            echo"<div class='card text-center bg-success text-white'>
            <!--<img src='".$row['images']."' alt='Department picture'>-->
            <h3 '>".$row['title']."</h3>
            <p>".$row['content']."</p>
            <small class='text-end rounded text-danger'>
                      <a class='nav-link' href='deleteblog.php?id=".$row['id']."'><button class='btn btn-danger'>
                      Delete</button></a>
